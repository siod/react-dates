...
import { addDays, addMonths, endOfWeek, getCalendarMonthWeeks, getWeekdayLabels, isCanonicalDate, startOfMonth, startOfWeek, today } from '../internal/date';
...
class DayPicker extends React.PureComponent {
  ...
  constructor(props) {
    super(props);
    const currentMonth = startOfMonth(props.hidden ? today() : props.initialVisibleMonth()) || today();
